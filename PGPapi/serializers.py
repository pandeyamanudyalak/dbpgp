...
class formDataSerializer(serializers.ModelSerializer):
    ...
    verifiyedByPerson1Flag=serializers.BooleanField(default=False)
    ...
    class Meta:
        ...
        fields = ('id','loggedPerson','date','typeOfWork','numberOfPerson','startTime','endTime','location',
                 ...
                 'newFlag','oldFlag','closeFlag','completedFlag','verifiyedByPerson1Flag')
    ...
    def update(self, instance, validated_data):
        ...
        instance.verifiyedByPerson1Flag = validated_data.get('verifiyedByPerson1Flag', instance.verifiyedByPerson1Flag)
